...
const Card = ({ children }: { children: ReactElement }) => (
  <div className="flex w-full flex-col items-center gap-4 rounded bg-gradient-to-br from-slate-400/40 to-slate-400/0 p-8 font-segoeui text-slate-100 md:flex-row md:items-start">
...
const Home: FunctionComponent = () => (
  <div className="container mx-auto flex flex-col items-center gap-8 py-4">
    ...
    <Card>
      <>
        <h1 className="text-4xl font-bold text-slate-100">Hi, I am Emre BAL</h1>
